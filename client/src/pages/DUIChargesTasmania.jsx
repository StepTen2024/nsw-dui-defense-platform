        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <nav className="text-sm mb-6">
              ...
              <span className="mx-2 text-primary-300">/</span>
              <span className="text-primary-100">Tasmania</span>
            </nav>
            
            <div className="flex items-center mb-6">
              <MapPin className="w-8 h-8 mr-3 text-primary-200" />
              <h1 className="font-heading font-bold text-4xl md:text-5xl">
                DUI Charges in Tasmania
              </h1>
            </div>
            <p className="text-xl text-primary-100 leading-relaxed mb-8">
              Complete guide to drink driving charges, penalties, and legal processes in Tasmania. 
              Understand your rights and defense options under Tasmanian traffic law.
            </p>
        ...
        <section className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="font-heading font-bold text-2xl text-secondary-900 mb-2">$200+</h3>
          ...
          <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 md:p-12 text-white">
            <div className="max-w-3xl mx-auto">
              ...
              <h2 className="font-heading font-bold text-3xl mb-4">
                Expert Tasmania DUI Defense
              </h2>
              <p className="text-xl text-primary-100 mb-8 leading-relaxed">
                Don't face Tasmania DUI charges alone. Get expert legal analysis 
...
export default DUIChargesTasmania; 